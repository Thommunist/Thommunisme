...
<h1 class="justify-center text-5xl">Portfolio</h1>

<div id="portofolio" class="m-2 flex max-w-full flex-wrap justify-evenly overflow-auto">
	<TopicMenu
		rounded=""
